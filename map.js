...
const edge_minimal = 0.; // 5e-324
const differentThanZero = Boolean(edge_minimal); // true
const toCloseToZero = Boolean(edge_minimal / 10); // false
const closestToZero = Number.MIN_VALUE; // 5e-324
edge_minimal === Number.MIN_VALUE; // true
const toCloseToOne = 1 === 1 + Number.EPSILON / 10; // true
const toLittleToBePrecise = Number.MIN_SAFE_INTEGER - 4 === Number.MIN_SAFE_INTEGER - 5; // true
...
const getArguments = function (a, b, c) {
...
const sentence = "You imagine I would like to.";
...
let fruit = fruits2.at(-1); // "Mango"
// IMPLEMENTING SIMPLE USE OF CALLBACK FUNCTION
const log = (v) => console.log(v); // function that will be called back
const add = (x, y, log) => {
